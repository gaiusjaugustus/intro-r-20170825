...
library(readr)
gapminder <- read_delim(file = "~/Documents/Rdocs/r-intro-20170825/datasets/gapminder.txt", 
...
```{r}
gapminder <- read_delim("~/Documents/Rdocs/r-intro-20170825/datasets/02_gapminder.txt", 
...
```{r}
gapminder[c(14,55,61),4]
# [1] # A tibble: 3 x 1
#   lifeExp
#     <dbl>
# 1  59.280
# 2  69.942
# 3  69.120 # check these against data view
```
...
```{r}
gapminder[c(14,55,61),]
# A tibble: 3 x 7
#     country continent  year lifeExp      pop gdpPercap lifeExpMonths
#       <chr>     <chr> <int>   <dbl>    <int>     <dbl>         <dbl>
# 1   Albania    Europe  1957  59.280  1476505  1942.284       711.360
# 2 Argentina  Americas  1982  69.942 29341374  8997.897       839.304
# 3 Australia   Oceania  1952  69.120  8691212 10039.596       829.440
```
...
table(is.above.avg) # another useful data summary command
# is.above.avg
# FALSE  TRUE 
#  1329   375 
```
