...
**Note:** To get rid of objects in your current session, use `rm()`, e.g. `rm(is.heavy, mammals, x, y)` ... or RStudio’s ‘broom’ button.



References:
Lectures from Ken Rice at University of Washington